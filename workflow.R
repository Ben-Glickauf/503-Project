...
#   - Calculates RMSE, AIC, BIC, classification accuracy,
...
# Notes
#
# • Running the scripts in the order above reproduces all
#   tables, figures, and numerical results presented in the
#   final report.
#
# • Random number generator seeds are set within the project
#   to ensure reproducibility.
#
# • Only base R functions are used throughout the project.
############################################################